...
parser.add_argument('--log_save_path', type=str,   default="/inspur/models/logs/log_mx_mnist_single/",  help='log out')
parser.add_argument('--model_save_path', type=str, default="/inspur/models/logs/log_mx_mnist_single/", help='model path')
