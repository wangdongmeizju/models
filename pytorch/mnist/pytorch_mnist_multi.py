...
parser.add_argument('--log_save_path',   default='/wangdongmei/models/logs/log_pytorch_mnist_multi', help='log save path')
parser.add_argument('--model_save_path', default='/wangdongmei/models/logs/log_pytorch_mnist_multi/ckpt.pth', help='log save path')
