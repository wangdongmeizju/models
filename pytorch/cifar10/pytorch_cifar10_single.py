...
parser.add_argument('--log_save_path',   default='/inspur/models/logs/log_pytorch_cifar_single', help='log save path')
parser.add_argument('--model_save_path', default='/inspur/models/logs/log_pytorch_cifar_single/ckpt.pth', help='log save path')
