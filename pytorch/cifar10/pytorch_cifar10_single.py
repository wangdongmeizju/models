...
parser.add_argument('--log_save_path',   default='/wangdongmei/models/logs/log_pytorch_cifar_single', help='log save path')
parser.add_argument('--model_save_path', default='/wangdongmei/models/logs/log_pytorch_cifar_single/ckpt.pth', help='log save path')
...
parser.add_argument('--num_gpus', default=1, type=int, help='gpu num')
...
print ('Training speed: %d'% (args.epoch*50000/totaltime))
