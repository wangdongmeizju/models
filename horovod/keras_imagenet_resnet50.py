...
parser.add_argument('--train-dir', default=os.path.expanduser('~/imagenet/ILSVRC2012_img_train_raw'),
                    help='path to training data')
parser.add_argument('--val-dir', default=os.path.expanduser('~/imagenet/ILSVRC2012_img_val_raw'),
